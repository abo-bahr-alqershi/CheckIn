...
class HomeLoaded extends HomeState {
  ...
  final Map<String, core.PaginatedResult<SearchResultModel>> sectionData;
  ...
  HomeLoaded copyWith({
    ...
    Map<String, core.PaginatedResult<SearchResultModel>>? sectionData,
...
class SectionDataLoaded extends HomeState {
  final String sectionId;
  final core.PaginatedResult<SearchResultModel> data;
