                ...
                return Transform.rotate(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      border: Border.all(
                        color: AppTheme.primaryBlue.withOpacity(0.2 - index * 0.05),
                        width: 0.5,
                      ),
                    ),
                  ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                widget.currentLocation.isNotEmpty ? widget.currentLocation : 'حدد المدينة',
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    final wiggle = hasNotifications
                        ? math.sin(_notificationAnimation.value * math.pi * 4) * 0.05
                        : 0.0;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double x = 0; x <= size.width; x++) {
      final y = size.height * 0.8 +
          math.sin((x / size.width * 2 * math.pi) + (animation * 2 * math.pi)) * 5;
      path.lineTo(x, y);
    }
