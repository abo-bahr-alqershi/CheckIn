                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: widget.isSelected
                          ? [
                              // ألوان للكارد المحدد
                              AppTheme.primaryBlue.withOpacity(isDarkMode ? 0.08 : 0.15),
                              AppTheme.primaryPurple.withOpacity(isDarkMode ? 0.05 : 0.10),
                            ]
                          : [
                              // شفافية زجاجية للكارد العادي
                              isDarkMode 
                                ? Colors.white.withOpacity(0.03)
                                : Colors.white.withOpacity(0.70), // شفافية 70% للوضع الفاتح
                              isDarkMode
                                ? Colors.white.withOpacity(0.01)
                                : Colors.white.withOpacity(0.50), // شفافية 50% للوضع الفاتح
                            ],
                    ),
                    borderRadius: BorderRadius.circular(widget.isCompact ? 14 : 16),
                    border: Border.all(
                      color: widget.isSelected
                          ? AppTheme.primaryBlue.withOpacity(0.3 + _glowAnimation.value * 0.2)
                          : isDarkMode
                              ? Colors.white.withOpacity(0.08)
                              : Colors.white.withOpacity(0.50), // حدود بيضاء شفافة للوضع الفاتح
            ...
            style: AppTextStyles.caption.copyWith(
              color: widget.isSelected 
                  ...
                  : isDarkMode
                      ...
                      : AppTheme.textDark.withOpacity(0.85), // نص داكن للوضع الفاتح
              ...
              style: AppTextStyles.caption.copyWith(
                color: widget.isSelected
                    ...
                    : isDarkMode
                        ...
                        : AppTheme.textDark.withOpacity(0.7), // نص واضح للوضع الفاتح
                fontSize: 9,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: widget.isSelected
                  ? LinearGradient(
                      colors: [
                        AppTheme.primaryBlue.withOpacity(isDarkMode ? 0.3 : 0.7),
                        AppTheme.primaryPurple.withOpacity(isDarkMode ? 0.2 : 0.5),
                      ],
                    )
                  : LinearGradient(
                      colors: isDarkMode
            ...
            child: Icon(
              ...
              color: widget.isSelected
                  ...
                  : isDarkMode
                      ...
                      : AppTheme.textDark.withOpacity(0.65), // أيقونة واضحة للوضع الفاتح
