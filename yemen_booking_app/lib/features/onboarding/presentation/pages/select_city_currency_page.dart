...
class _SelectCityCurrencyPageState extends State<SelectCityCurrencyPage>
  ...
  Widget _buildCitySelection(List<City> cities) {
    final filteredCities = _citySearchQuery.isEmpty
        ? cities
        : cities.where((city) =>
            city.name.toLowerCase().contains(_citySearchQuery.toLowerCase()) ||
            city.country.toLowerCase().contains(_citySearchQuery.toLowerCase())
          ).toList();
  ...
  Widget _buildCurrencySelection(List<Currency> currencies) {
    final filteredCurrencies = _currencySearchQuery.isEmpty
        ...
        : currencies.where((currency) =>
            currency.code.toLowerCase().contains(_currencySearchQuery.toLowerCase()) ||
            currency.arabicName.toLowerCase().contains(_currencySearchQuery.toLowerCase()) ||
            currency.name.toLowerCase().contains(_currencySearchQuery.toLowerCase())
          ).toList();
