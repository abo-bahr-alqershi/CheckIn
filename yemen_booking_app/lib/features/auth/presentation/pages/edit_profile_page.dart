...
class _EditProfilePageState extends State<EditProfilePage>
  ...
  void _loadUserData() {
    ...
    // This would normally come from AuthBloc state
    _nameController.text = ''; // Load from state
    _phoneController.text = ''; // Load from state
    _emailController.text = ''; // Load from state
    _bioController.text = ''; // Load from state
  }
