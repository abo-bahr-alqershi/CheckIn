...
public class ImageProcessingService : IImageProcessingService
{
    ...
    public async Task<YemenBooking.Application.Interfaces.Services.ImageInfo> GetImageInfoAsync(
        Stream imageStream,
        CancellationToken cancellationToken = default)
    {
        try
    ...
    private static YemenBooking.Application.Interfaces.Services.ImageInfo CreateImageInfo(Image image, long fileSize)
    {
        var format = DetectImageFormat(image);
        
        return new YemenBooking.Application.Interfaces.Services.ImageInfo
        {
            Width = image.Width,
            Height = image.Height,
            Format = format,
