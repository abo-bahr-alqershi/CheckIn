...
class PaymentAnalyticsBloc
  ...
  Future<void> _onLoadPaymentAnalytics(
    ...
    try {
      ...
      final analyticsResult = await getPaymentAnalyticsUseCase(
      ...
      // تحميل الاتجاهات
      final trendsResult = await getPaymentTrendsUseCase(
      ...
      // تحميل إحصائيات الاستردادات
      final refundStatsResult = await getRefundStatisticsUseCase(
